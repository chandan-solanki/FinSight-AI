...
const Header = () => {
  return (
    <div className=" w-full bg-white/50 backdrop-blur-md top-0 fixed border-b z-50">
      <nav className="flex mx-auto overflow-hidden w-full justify-between items-center px-5 py-2">
        <Link href={"/"} className="">
          <Image
            src={"/logo (2).png"}
            width={500}
        ...
        <div className="flex items-center space-x-4">
          <SignedIn>
            ...
            >
              <Button className={"cursor"} variant={"ghost"}>
                <LayoutDashboard />
